...
const metrics = [
  { label: "Top-1 Accuracy", value: "81.0", suffix: "%", delta: "+2.4 vs prev epoch", tone: "default" as const, color: "var(--primary)", spark: spark(1) },
  { label: "Top-5 Accuracy", value: "100.0", suffix: "%", delta: "saturated · 14 families", tone: "success" as const, color: "oklch(0.6 0.16 150)", spark: spark(2) },
  { label: "OOD Accuracy", value: "49.5", suffix: "%", delta: "held-out · 6 families", tone: "warning" as const, color: "oklch(0.72 0.16 75)", spark: spark(0.5) },
